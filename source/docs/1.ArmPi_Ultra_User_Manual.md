...
(1) Click <img src="../_static/media/chapter_1/section_1/media/image36.png" style="width:50px" /> to enter the mode's interface, then the robotic arm returns to an straight posture.
...
(3) Tap-on <img src="../_static/media/chapter_1/section_1/media/image58.png" style="width:50px" /> to enable the robotic arm to restore its initial position.
...
In this mode, you can sort blocks by color or label. Click <img src="../_static/media/chapter_1/section_1/media/image37.jpeg" style="width:50px" /> to enter the mode's interface. This interface is divided into three sections:
...
(1) Click <img src="../_static/media/chapter_1/section_1/media/image38.jpeg" style="width:70px" /> to enter the mode's interface. This interface is divided into three sections:

① On the left side, you can start the feature.

② The right side of the interface is the live camera feed.

③ Click the button <img src="../_static/media/chapter_1/section_1/media/image64.png" style="width:100px" /> on the left to view instructions for this mode.
...
Click <img src="../_static/media/chapter_1/section_1/media/image76.png" style="width:50px" /> to enter the mode's interface. This interface is divided into three sections:
...
Click <img src="../_static/media/chapter_1/section_1/media/image40.jpeg" style="width:50px" /> to enter the mode's interface. This interface is divided into three sections:
...
Click <img src="../_static/media/chapter_1/section_1/media/image41.png" style="width:70px"/> to enter the mode's interface. This interface is divided into three sections:
...
Click <img src="../_static/media/chapter_1/section_1/media/image42.png" style="width:70px"/> to enter the mode's interface. This interface is divided into three sections:
...
(2) In the Mode Selection screen, tap the icon <img src="../_static/media/chapter_1/section_1/media/image81.png" style="width:50px" /> at the top right corner to enter the color threshold setting interface.
...
(2) Click on the button <img src="../_static/media/chapter_1/section_1/media/image90.png" style="width:50px" />, then click **Execute**.
...
(3) For the instructions and use of the interface buttons, you can refer to the subsequent content of this document. To close it, click <img src="../_static/media/chapter_1/section_1/media/image93.png" style="width:50px" /> and select "**Yes**" in the pop-up prompt.
...
(2) Click the terminal icon <img src="../_static/media/chapter_1/section_1/media/image138.png" style="width:50px" /> in the system desktop to open a command-line window.
...
ROS2 Environment Terminal: This terminal provides access to robot-related features and functions. It will be frequently used in the following lessons. <img src="../_static/media/chapter_1/section_1/media/image146.png" style="width:50px" />
...
(2) Double-click the "**Tool**" icon <img src="../_static/media/chapter_1/section_1/media/image148.png" style="width:50px" /> to launch the robot system configuration tool, then click "**Execute**".
...
(6) Open the terminal again <img src="../_static/media/chapter_1/section_1/media/image146.png" style="width:50px" /> to view the ROS2 environment.
...
(8) Once all steps are complete, click **Hand-Eye Calibration** to save the parameters.

<img class="common_img" src="../_static/media/chapter_1/section_1/media/image164.png" style="width:500px" />

(9) To exit, click the button <img src="../_static/media/chapter_1/section_1/media/image165.png" style="width:50px" /> in the top-right corner of the software and select **Yes**.

<img class="common_img" src="../_static/media/chapter_1/section_1/media/image166.png" style="width:300px" />

### 1.8.2 Position Adjustment Tool

(1) Follow the instructions in [1.6 Development Environment Setup and Configuration](#anchor_1_6) of this document to remotely connect the device to the system desktop.

(2) Click on <img src="../_static/media/chapter_1/section_1/media/image167.png" style="width:50px" />to open a new command line terminal. 
...
Select "**Calibration**" from the feature selection drop-down menu, then click the "**Calibration**" button. Two yellow boxes will appear as shown.
...
(3) After adjusting the values, it is necessary to click "**Save**" to apply the settings to the robotic arm's grasping program. Then click "**Init**" to return the arm to its recognition and grasping state, followed by clicking "**Center**" to have the robot arm move to the center position and grasp the block.
...
(1) Select "**Pixel Location**" and place the block at the center position, where the QR code is located.
...
(1) Select "**Depth Location**" and place the block at the center position, where the QR code is located.
...
(1) Click <img src="../_static/media/chapter_1/section_1/media/image195.png" style="width:50px" /> to open the command terminal, enter the following command, and press Enter to list the files in the home directory:
