...
This is an optional hardware module that enables voice wake-up and voice control functions on the robot. For related tutorials, please refer to the document "[10. Voice Control Lesson->10.1 Voice Control Basic Lesson]()
