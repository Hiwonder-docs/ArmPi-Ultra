...
1)  Click the terminal icon <img src="../_static/media/chapter_9/media/image3.png" style="width:50px" /> in the system desktop to open a command-line window. Enter the following command and press **Enter** to stop the auto-start service:
...
4)  After completing the feature, you need to start the APP service<img src="../_static/media/chapter_9/media/image3.png" style="width:50px" />. **Otherwise, future APP features may not function properly.** In the terminal, enter the following command and press **Enter** to start the app service. Wait a few seconds for it to initialize.
...
<img class="common_img" src="../_static/media/chapter_9/media/image7.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_9/media/image18.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_9/media/image28.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_9/media/image35.png" style="width:500px" />
...
5)  After completing the feature, you need to start the APP service<img src="../_static/media/chapter_9/media/image3.png" style="width:50px" />. **Otherwise, future APP features may not function properly.** In the terminal, enter the following command and press **Enter** to start the app service. Wait a few seconds for it to initialize.
...
<img class="common_img" src="../_static/media/chapter_9/media/image54.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_9/media/image15.png" style="width:500px" />
