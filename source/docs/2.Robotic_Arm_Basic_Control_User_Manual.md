...
(1) Assemble the robotic arm according to the tutorial stored in [1.ArmPi Ultra User Manual-> Accessories Installation and Notes]().

(2) Start the robotic arm according to the tutorial saved in [2.ArmPi Ultra User Manual/3. Power-On Description]().

(3) Access the robotic arm system desktop according to the tutorials locating in [ArmPi Ultra User Manual->1.6 Development Environment Setup and Configuration]().
...
The launch files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/bus_servo.launch.py]()
...
The Python files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/include/bus_servo_node.py]()
...
(1) Assemble the robotic arm according to the tutorial stored in  [1. ArmPi Ultra User Manual/1.2 Accessories Installation and Notes]().

(2) Start the robotic arm according to the tutorial saved in [1. ArmPi Ultra User Manual->1.3 Power-On Description]().

(3) Access the robotic arm system desktop according to the tutorials locating in [1. ArmPi Ultra User Manual->1.6 Development Environment Setup and Configuration]()
...
The files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/led.launch.py]()
...
The Python files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/include/led_node.py]()
...
(1) Assemble the robotic arm according to the tutorial stored in [ArmPi Ultra User Manual->1.2 Accessories Installation and Notes]()

(2) Start the robotic arm according to the tutorial saved in [ArmPi Ultra User Manua->1.3 Power-On Description]().
...
The launch files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/buzzer.launch.py]()
...
The Python files are located at: [/home/ubuntu/ros2_ws/src/example/example/simple/include/buzzer_node.py]()
...
| **Icon** | **Function** |
|:--:|----|
| <img class="common_img" src="../_static/media/chapter_2/media/image44.png"  /> | Indicates the servo ID number, for example, 1 is the servo’s ID here. |
| <img class="common_img" src="../_static/media/chapter_2/media/image45.png"  /> | Adjust the servo position, with a range from 0 to 1000. |
| <img class="common_img" src="../_static/media/chapter_2/media/image46.png"  /> | Adjust the servo deviation, with a range from -125 to 125. For detailed information, please refer to section **4.4 Deviation Adjustment** in this document. |
...
| **Icon** | **Function** |
|:--:|----|
| <img class="common_img" src="../_static/media/chapter_2/media/image48.png"  /> | The ID number of the action. |
| <img class="common_img" src="../_static/media/chapter_2/media/image49.png"  /> | The time required to execute the action, in milliseconds. |
| <img class="common_img" src="../_static/media/chapter_2/media/image50.png"  /> | The values of the servos corresponding to this ID can be modified directly by double-clicking the numbers below<img class="common_img" src="../_static/media/chapter_2/media/image51.png"   />. |
...
<tbody>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image52.png" style="width:1.92708in;height:0.41667in" /></td>
<td>Displays the time required to run a single action, click <img class="common_img"  src="../_static/media/chapter_2/media/image53.png" style="width:0.40625in;height:0.27083in" alt="QQ截图20210227154112" /> to modify.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image54.png" style="width:1.90625in;height:0.29167in" /></td>
<td>Shows the total duration required for the action group to run.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image55.png" style="width:1.15625in;height:0.41667in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image56.png" style="width:1.13542in;height:0.40625in" /></td>
<td>Reads the servo positions when manually moved. This must be used together with the "Manual" button.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image57.png" style="width:1.02083in;height:0.375in" /></td>
<td>Adds the current servo values from the servo control area as an action to the last row of the action details list.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image58.png" style="width:1.11458in;height:0.45833in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image59.png" style="width:1.03125in;height:0.39583in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image60.png" style="width:1.08333in;height:0.41667in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image61.png" style="width:1.09375in;height:0.41667in" /></td>
<td>Moves the selected action up one row.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image62.png" style="width:1.09375in;height:0.41667in" /></td>
<td>Moves the selected action down one row.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image63.png" style="width:0.76042in;height:1.38542in" /></td>
<td><p>Clicks to run the actions in Action Details List once.</p>
<p>If "Loop" is checked, the robot will repeat the sequence.</p></td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image64.png" style="width:1.28125in;height:0.53125in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image65.png" style="width:1.26042in;height:0.48958in" /></td>
<td><p>Save the actions currently in the Action Details List to a specified location.</p>
<p>The action files are located at:</p>
<p>/home/ubuntu/software/armpi_ultra_control/ActionGrourps</p></td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image66.png" style="width:1.27083in;height:0.51042in" /></td>
...
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image67.png" style="width:1.8125in;height:0.375in" /></td>
<td>Displays the saved action groups in the computer.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image68.png" style="width:1.15625in;height:0.5in" /></td>
<td>Executes the selected action group once.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image69.png" style="width:1.1875in;height:0.52083in" /></td>
<td>Stops the currently running action group.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image70.png" style="width:1.16667in;height:0.52083in" /></td>
<td>Exits the current PC software interface.</td>
</tr>
<tr>
<td style="text-align: center;"><img class="common_img"  src="../_static/media/chapter_2/media/image71.png" style="width:0.70833in;height:0.41667in" /></td>
<td>Pressing this button refreshes the action group selection list.</td>
</tr>
</tbody>
</table>

④: Deviation Adjustment Area (For detailed information, please refer to section [2.4.4 Deviation Adjustment]() in this document.)

| **Icon** | **Function** |
|:--:|----|
| <img class="common_img" src="../_static/media/chapter_2/media/image72.png"  /> | Click to automatically read the saved deviation values. |
| <img class="common_img" src="../_static/media/chapter_2/media/image73.png"  /> | Click to upload the adjusted deviation values from the software to the robot. |
| <img class="common_img" src="../_static/media/chapter_2/media/image74.png"  /> | Click to reset all servo in the Servo Control Area to position 500. |
...
(3) Access the robotic arm system desktop according to the tutorials locating in [1. ArmPi Ultra User Manual/6. Development Environment Setup and Configuration]().

* **Determine Minor and Major Deviation**

(1) After remotely connecting to the robot, click the PC software icon <img class="common_img" src="../_static/media/chapter_2/media/image40.png"  /> on the system desktop.
...
(6) If the angle between a servo and the center line is less than 30° and it can be corrected through the PC software, it is considered a minor deviation. You can adjust it following the [2.4.4 Deviation Adjudtment -> Minor Deviation Adjustment]() section in this document. For example, the deviation of servo 3 is shown below.
...
Do not forcefully turn the servo shaft, and ensure the horns are properly aligned. If not, repeat the steps in [2.4.4 Deviation Adjustment ->Major Deviation Adjustment]() of this document.
...
(10) Then, power on the device and repeat the steps in [2.4.4 Deviation Adjustment -> Minor Deviation Adjustment]() of this document to fine-tune the deviation.

## 2.5 Using the Servo Debugging Tool

When replacing a new servo, use the servo debugging tool to set the servo ID, central position, and other parameters. The ID numbering of servos can be found in the previous section [2.1.1 Introduction to Servo Control Node]().
...
(1) Refer to the tutorial [1. ArmPi Ultra User Manual->1.6 Development Environment Setup and Configuration]() to establish a connection between the robot and the remote desktop tool.
...
(6) After setting the servo ID, you can proceed to the section [2.4.4 Deviation Adjustment Major->Deviation Adjustment]() in this document for servo disassembly and assembly.