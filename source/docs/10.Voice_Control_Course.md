...
<img class="common_img" src="../_static/media/chapter_10/section_1/media/image1.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_1/media/image3.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_1/media/image4.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_1/media/image5.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image1.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image2.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image3.png" style="width:500px" />

4)  Locate and select the appropriate serial port.

<img class="common_img" src="../_static/media/chapter_10/section_2/media/image4.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image5.png" style="width:300px" />

<img class="common_img" src="../_static/media/chapter_10/section_2/media/image6.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image7.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_2/media/image8.png" style="width:500px" />

<img class="common_img" src="../_static/media/chapter_10/section_2/media/image9.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image1.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image2.png" style="width:700px" />

4)  When the page redirects, click the option <img src="../_static/media/chapter_10/section_3/media/image3.png" style="width:200px" /> on the left panel to create a new product as shown in the image below. Product name and description can be customized. Other fields must be selected according to the red boxes in the example. Product type needs to select Select General  Smart Control Hub, then click "Create" to complete.

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image4.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image5.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image6.png" style="width:700px" />

7)  In the Hardware Parameters section, set the **Crystal Oscillator Source** to Internal RC and disable Baud Rate Calibration.

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image7.png" style="width:700px" />

8)  In the UART Print Settings, configure UART1 to Open-Drain Mode, supporting external 5V pull-up.

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image8.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image9.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image10.png" style="width:700px" />

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image11.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image12.png" style="width:700px" />

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image13.png" style="width:700px" />

12) After uploading the file, you will see the command data populated in the table below.

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image14.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_3/media/image15.png" style="width:700px" />

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image16.png" style="width:700px" />

<img class="common_img" src="../_static/media/chapter_10/section_3/media/image17.png" style="width:700px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_4/media/image1.png" style="width:700px" />

2)  Connect the AI voice interaction module to Port 3 of the controller.

<img class="common_img" src="../_static/media/chapter_10/section_4/media/image2.png" style="width:400px" />
...
4)  Click the terminal icon <img src="../_static/media/chapter_10/section_5/media/image4.png" style="width:50px" /> in the system desktop to open a command-line window.
...
<img class="common_img" src="../_static/media/chapter_10/section_5/media/image6.png" style="width:500px" />
...
<img class="common_img" src="../_static/media/chapter_10/section_5/media/image7.png" style="width:500px" />
...
10. After completing the feature, you need to initiate the app service. <img src="../_static/media/chapter_10/section_5/media/image4.png" style="width:50px" /> **Otherwise, future APP features may not function properly.** In the terminal, enter the following command and press **Enter** to start the app service. Wait a few seconds for it to initialize.
    ...
    def words_callback(self, msg):
        ...
        if words is not None and words not in ['唤醒成功(wake-up-success)', '休眠(Sleep)', '失败5次(Fail-5-times)',
            ...
            if words == '追踪红色' or words == 'track red object':
                ...
                req.data = 1.0 #Tracked color: 0.0 = no tracking, 1.0 = red, 2.0 = green, 3.0 = blue (追踪的颜色 0.0为不追踪， 1.0为红色， 2.0为绿色，3.0为蓝色)
                ...
                req = SetFloat64.Request()
                req.data = 2.0 #Tracked color: 0.0 = no tracking, 1.0 = red, 2.0 = green, 3.0 = blue (追踪的颜色 0.0为不追踪， 1.0为红色， 2.0为绿色，3.0为蓝色)
                res = self.send_request(self.set_color_client, req)
                if res.success:
                ...
                req = SetFloat64.Request()
                req.data = 3.0 #Tracked color: 0.0 = no tracking, 1.0 = red, 2.0 = green, 3.0 = blue (追踪的颜色 0.0为不追踪， 1.0为红色， 2.0为绿色，3.0为蓝色)色
                res = self.send_request(self.set_color_client, req)
                if res.success:
...
<img class="common_img" src="../_static/media/chapter_10/section_6/media/image1.png" style="width:300px" />

<p style="text-align:center">WonderEcho Pro</p>

2)  The robot currently uses the AI voice module WonderEchoPro, which requires setting the recognition language. On the desktop, double-click the Tool icon <img src="../_static/media/chapter_10/section_6/media/image2.png" style="width:50px" /> to open the configuration tool. Select the target language.

<img class="common_img" src="../_static/media/chapter_10/section_6/media/image3.png" style="width:500px" />

3)  Click **Save**.

<img class="common_img" src="../_static/media/chapter_10/section_6/media/image4.png" style="width:300px" />

4)  Click **Apply**.

<img class="common_img" src="../_static/media/chapter_10/section_6/media/image5.png" style="width:300px" />

5)  Click **Quit**.

<img class="common_img" src="../_static/media/chapter_10/section_6/media/image6.png" style="width:300px" />